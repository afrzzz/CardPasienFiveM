  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#4ade80] p-6">
      <div className="bg-white rounded-2xl shadow-2xl grid md:grid-cols-2 w-full max-w-5xl overflow-hidden">
        ...
        {/* Card Preview */}
        {/* Preview yang kelihatan (pakai animasi) */}
        <motion.div
        ...
        >
          {/* Front tampilan */}
          <div className="absolute inset-0 bg-[#22c55e] p-6 flex flex-col justify-between backface-hidden">
          ...
          {/* Back tampilan */}
          <div className="absolute inset-0 bg-[#1f2937] p-6 flex flex-col justify-center rotate-y-180 backface-hidden">
        ...
        {/* 👇 Hidden static front untuk capture */}
        <div
          ref={frontRef}
          className="hidden absolute bg-[#22c55e] p-6 text-white"
          style={{
            width: "400px",
            height: "250px",
            borderRadius: "1.5rem",
